// Custom R2 Upload Widget for Netlify CMS
(function() {
  var R2Uploader = function() {};
  
  R2Uploader.prototype.init = function() {
    return null;
  };
  
  R2Uploader.prototype.show = function(options) {
    var self = this;
  ...
  // Register with CMS
  if (window.CMS) {
    window.CMS.registerMediaLibrary(new R2Uploader(), { name: 'r2-uploader' });
  }
})();